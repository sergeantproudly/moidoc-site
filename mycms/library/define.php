<?php
	...
	function GetUserStatuses(){
		$userStatuses=Array(
			PERMISSION_MASK_MODERATOR		=> 'Moderator access',
			PERMISSION_MASK_ADMINISTRATOR	=> 'administrator access',
			PERMISSION_MASK_DEVELOPER		=> 'Developer access'
		);
		return $userStatuses;
	}
	...
	function GetFolders(){
		$folders=Array(
			Array('Title'=>'Documents','Icon'=>'','Module'=>'documents','Link'=>'index.php?module=documents','PermissionMask'=>PERMISSION_MASK_DEVELOPER),
			Array('Title'=>'Elements','Module'=>'elements','Link'=>'','PermissionMask'=>PERMISSION_MASK_DEVELOPER),
			Array('Title'=>'Tables','Icon'=>'','Module'=>'tables','Link'=>'index.php?module=tables','PermissionMask'=>PERMISSION_MASK_DEVELOPER),
			Array('Title'=>'Fields','Module'=>'fields','Link'=>'','PermissionMask'=>PERMISSION_MASK_DEVELOPER),
			Array('Title'=>'Site management','Icon'=>'','Module'=>'records','Link'=>'index.php?module=records','PermissionMask'=>PERMISSION_MASK_DEVELOPER|PERMISSION_MASK_ADMINISTRATOR),
			Array('Title'=>'Users','Icon'=>'','Module'=>'users','Link'=>'index.php?module=users','PermissionMask'=>PERMISSION_MASK_DEVELOPER|PERMISSION_MASK_ADMINISTRATOR|PERMISSION_MASK_MODERATOR),
